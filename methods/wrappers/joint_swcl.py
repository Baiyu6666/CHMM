...
def _fit_single_swcl(kwargs: Dict[str, Any], dataset: TaskBundle) -> Dict[str, Any]:
    learner = StageWiseConstraintLearningModel(
        ...
        truncated_z_score_mode=kwargs.get("truncated_z_score_mode", "fast_fit"),
        truncated_z_soft_boundary_scale=kwargs.get("truncated_z_soft_boundary_scale", 0.1),
        truncated_z_observation_noise_scale=kwargs.get("truncated_z_observation_noise_scale", 0.03),
