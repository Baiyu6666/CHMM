...
class JointSegConsMethod:
    ...
    def fit(self, dataset: TaskBundle) -> Dict[str, Any]:
        ...
        learner = SegmentConstraintModel(
            ...
            use_subgoal_consistency=self.kwargs.get("use_subgoal_consistency", True),
            use_transition_term=self.kwargs.get("use_transition_term", True),
            progress_term_type=self.kwargs.get("progress_term_type", "vmf"),
